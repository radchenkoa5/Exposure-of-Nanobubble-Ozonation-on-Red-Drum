...
```{r}
summary(lm(Gill.Score ~ Treatment + Chla, data = gill))
```


```{r}
model1 <- lm(Gill.Score ~ gill$Treatment + Condition.Factor + Chla + DO + Max.DO + Salinity + pH + Temp + Secchi, data = gill)
...
Gill.Score ~ Treatment + Time + Max.DO + Salinity + pH + Temp + Chla + Secchi
